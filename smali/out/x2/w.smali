...
.method private static a(Ljava/lang/String;Ljava/util/concurrent/ExecutorService;)V
    ...
    invoke-static {p0, p1, v1, v2, v0}, Lx2/w;->b(Ljava/lang/String;Ljava/util/concurrent/ExecutorService;JLjava/util/concurrent/TimeUnit;)V
...
.method private static b(Ljava/lang/String;Ljava/util/concurrent/ExecutorService;JLjava/util/concurrent/TimeUnit;)V
    ...
    invoke-direct/range {v2 .. v7}, Lx2/w$b;-><init>(Ljava/lang/String;Ljava/util/concurrent/ExecutorService;JLjava/util/concurrent/TimeUnit;)V
...
.method public static c(Ljava/lang/String;)Ljava/util/concurrent/ExecutorService;
    ...
    .line 1
    invoke-static {p0}, Lx2/w;->d(Ljava/lang/String;)Ljava/util/concurrent/ThreadFactory;
    ...
    .line 3
    invoke-static {v0, v1}, Lx2/w;->e(Ljava/util/concurrent/ThreadFactory;Ljava/util/concurrent/RejectedExecutionHandler;)Ljava/util/concurrent/ExecutorService;

    move-result-object v0

    .line 4
    invoke-static {p0, v0}, Lx2/w;->a(Ljava/lang/String;Ljava/util/concurrent/ExecutorService;)V
...
.method public static d(Ljava/lang/String;)Ljava/util/concurrent/ThreadFactory;
    ...
    invoke-direct {v1, p0, v0}, Lx2/w$a;-><init>(Ljava/lang/String;Ljava/util/concurrent/atomic/AtomicLong;)V
